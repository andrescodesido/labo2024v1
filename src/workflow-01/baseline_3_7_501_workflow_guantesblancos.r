...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_3_7Basel", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_3_7Basel", "DT0001_3_7Basel" )

  DR_drifting_guantesblancos( "DR0001_3_7Basel", "CA0001_3_7Basel" )
  FE_historia_guantesblancos( "FE0001_3_7Basel", "DR0001_3_7Basel" )

  TS_strategy_guantesblancos_202109( "TS0001_3_7Basel", "FE0001_3_7Basel" )

  HT_tuning_guantesblancos( "HT0001_3_7Basel", "TS0001_3_7Basel" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_3_7Basel", c("HT0001_3_7Basel","TS0001_3_7Basel") )
...
corrida_guantesblancos_202109( "gb01_3_7Basel" )
