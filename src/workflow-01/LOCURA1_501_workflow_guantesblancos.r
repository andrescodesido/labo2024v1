...
FE_historia_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$RandomForest$mtry <- 25
...
TS_strategy_guantesblancos_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(201904,201905,201906,201907,201908,201909,201910,201911,201912,
                               202001,202002,202003,202004,202005,202006,202007,202008,202009,202010,202011,202012,
                               202101,202102,202103,202104,202105,202106,202107)


  param_local$train$training <- c(201904,201905,201906,201907,201908,201909,201910,201911,201912,
                               202001,202002,202003,202004,202005,202006,202007,202008,202009,202010,202011,202012,
...
#{
 ...
 # param_local$final_train <- c(201901,201902,201903,201904,201905,201906,201907,201908,201909,201910,201911,201912,
  #                             202001,202002,202003,202004,202005,202006,202007,202008,202009,202010,202011,202012,
  #                             202101,202102,202103,202104,202105)


 # param_local$train$training <- c(2201901,201902,201903,201904,201905,201906,201907,201908,201909,201910,201911,201912,
   #                            202001,202002,202003,202004,202005,202006,202007,202008,202009,202010,202011,202012,
...
HT_tuning_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    learning_rate = c( 0.007, 0.3 ),
    feature_fraction = c( 0.4, 0.8 ),
    num_leaves = c( 100L, 2000L,  "integer" ),
    min_data_in_leaf = c( 80L, 2000L, "integer" )
  )
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_LO1", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_LO1", "DT0001_LO1" )

  DR_drifting_guantesblancos( "DR0001_LO1", "CA0001_LO1" )
  FE_historia_guantesblancos( "FE0001_LO1", "DR0001_LO1" )

  TS_strategy_guantesblancos_202109( "TS0001_LO1", "FE0001_LO1" )

  HT_tuning_guantesblancos( "HT0001_LO1", "TS0001_LO1" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_LO1", c("HT0001_LO1","TS0001_LO1") )
...
#{
 # if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  ...
  #TS_strategy_guantesblancos_202107( "TS0002_3_7Basel", "FE0001_3_7Basel" )

  #HT_tuning_guantesblancos( "HT0002_3_7Basel", "TS0002_3_7Basel" )

  # El ZZ depente de HT y TS
  #ZZ_final_guantesblancos( "ZZ0002_3_7Basel", c("HT0002_3_7Basel", "TS0002_3_7Basel") )
...
corrida_guantesblancos_202109( "gb01_LO1" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

#corrida_guantesblancos_202107( "gb02_3_7Basel" )
