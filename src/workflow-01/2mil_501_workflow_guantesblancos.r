...
TS_strategy_guantesblancos_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(201903,201904,201905,201906,201907,201908,201909,201910,201911,201912,
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_2mil1", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_2mil1", "DT0001_2mil1" )

  DR_drifting_guantesblancos( "DR0001_2mil1", "CA0001_2mil1" )
  FE_historia_guantesblancos( "FE0001_2mil1", "DR0001_2mil1" )

  TS_strategy_guantesblancos_202109( "TS0001_2mil1", "FE0001_2mil1" )

  HT_tuning_guantesblancos( "HT0001_2mil1", "TS0001_2mil1" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_2mil1", c("HT0001_2mil1","TS0001_2mil1") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_2mil1", "FE0001_2mil1" )

  HT_tuning_guantesblancos( "HT0002_2mil1", "TS0002_2mil1" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_2mil1", c("HT0002_2mil1", "TS0002_2mil1") )
...
corrida_guantesblancos_202109( "gb01_2mil1" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_2mil1" )
