...
TS_strategy_guantesblancos_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202006,202007,202008,202009,202010,202011,202012,
                               202101,202102,202103,202104,202105,202106,202107)


  param_local$train$training <- c(202006,202007,202008,202009,202010,202011,202012,
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_5_6Basel", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_5_6Basel", "DT0001_5_6Basel" )

  DR_drifting_guantesblancos( "DR0001_5_6Basel", "CA0001_5_6Basel" )
  FE_historia_guantesblancos( "FE0001_5_6Basel", "DR0001_5_6Basel" )

  TS_strategy_guantesblancos_202109( "TS0001_5_6Basel", "FE0001_5_6Basel" )

  HT_tuning_guantesblancos( "HT0001_5_6Basel", "TS0001_5_6Basel" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_5_6Basel", c("HT0001_5_6Basel","TS0001_5_6Basel") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_5_6Basel", "FE0001_5_6Basel" )

  HT_tuning_guantesblancos( "HT0002_5_6Basel", "TS0002_5_6Basel" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_5_6Basel", c("HT0002_5_6Basel", "TS0002_5_6Basel") )
...
corrida_guantesblancos_202109( "gb01_5_6Basel" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_5_6Basel" )
