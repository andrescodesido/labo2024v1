...
TS_strategy_guantesblancos_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(201902,201903,201904,201905,201906,201907,201908,201909,201910,201911,201912,
                               202001,202002,202003,202004,202005,202006,202007,202008,202009,202010,202011,202012,
                               202101,202102,202103,202104,202105,202106,202107)


  param_local$train$training <- c(201902,201903,201904,201905,201906,201907,201908,201909,201910,201911,201912,
                               202001,202002,202003,202004,202005,202006,202007,202008,202009,202010,202011,202012,
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_mil1", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_mil1", "DT0001_mil1" )

  DR_drifting_guantesblancos( "DR0001_mil1", "CA0001_mil1" )
  FE_historia_guantesblancos( "FE0001_mil1", "DR0001_mil1" )

  TS_strategy_guantesblancos_202109( "TS0001_mil1", "FE0001_mil1" )

  HT_tuning_guantesblancos( "HT0001_mil1", "TS0001_mil1" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_mil1", c("HT0001_mil1","TS0001_mil1") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_mil1", "FE0001_mil1" )

  HT_tuning_guantesblancos( "HT0002_mil1", "TS0002_mil1" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_mil1", c("HT0002_mil1", "TS0002_mil1") )
...
corrida_guantesblancos_202109( "gb01_mil1" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_mil1" )
